...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, KC_LCBR,                   KC_RCBR, KP_7,    KP_8,    KP_9,    KC_PLUS, _______,
  _______, _______, _______, _______, _______, KC_LPRN,                   KC_RPRN, KP_4,    KP_5,    KP_6,    KC_EQL,  _______,
  _______, _______, _______, _______, _______, KC_LBRC, _______, _______, KC_RBRC, KP_1,    KP_2,    KP_3,    KC_BSLS, _______,
                             _______, _______, _______, _______, ADJUST,  KC_0,    _______, _______
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
